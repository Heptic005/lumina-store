                ...
                <ScrollReveal delay={0.4}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 rounded-3xl p-8 relative overflow-hidden h-80 flex flex-col justify-center border border-white/5 group">
                            ...
                            <img src="/lumina-gx.jpg" alt="Phone" className="absolute right-6 top-1/2 -translate-y-1/2 h-64 w-auto object-cover rounded-2xl shadow-lg shadow-indigo-900/50 border border-white/10 group-hover:scale-105 transition-transform duration-500" />
                        </div>
                        <div className="bg-gradient-to-br from-slate-900 to-gray-900 rounded-3xl p-8 relative overflow-hidden h-80 flex flex-col justify-center border border-white/5 group">
                            ...
                            <img src="/lumina-console.jpg" alt="Console" className="absolute right-6 top-1/2 -translate-y-1/2 h-64 w-auto object-cover rounded-2xl shadow-lg shadow-black/50 border border-white/10 group-hover:scale-105 transition-transform duration-500" />
                        </div>
                    </div>
                </ScrollReveal>
            </section>
                ...
                <ScrollReveal>
                    <div className="bg-gradient-to-br from-gray-900 to-slate-800 rounded-3xl p-8 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center border border-white/5">
                        ...
                        <div className="flex-1 relative z-10 flex justify-center">
                            ...
                            <img src="/lumina-watch-gt.jpg" alt="Watch" className="relative w-64 h-64 object-cover rounded-[2rem] shadow-2xl shadow-black/50 hover:scale-105 hover:rotate-2 transition-all duration-500 border-4 border-white/10" />
                        </div>
                        {/* Background effect */}
